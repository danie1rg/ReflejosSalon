...
namespace Logica.Services
{
    public class Conexion
    {
        ...
        String CadenaDeConexión { get; set; }
        ...
        */
        public int EjecutarInsertUpdateDelete(String NombreSP)
        {
            ...
            using (SqlConnection MyCnn = new SqlConnection(CadenaDeConexión))
        ...
        */
        ...
        public Conexion()
        {
            this.CadenaDeConexión = ConfigurationManager.ConnectionStrings["CNNSTR"].ToString();
